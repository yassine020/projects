...
function affichage_de_java(){
    var paragraph = document.getElementById("text").value ;
    if(paragraph.indexOf('<ol start="5">') != -1){
        s = s + 1
    }
    else if(paragraph.indexOf('<li>bonjour</li>') != -1){
        s = s + 0.25
    }
    else if(paragraph.indexOf('<ul>') != -1){
        s = s + 0.25
    }
    else if(paragraph.indexOf('<li>hi</li>') != -1){
        s = s + 0.25
    }
    else if(paragraph.indexOf('</ul>') != -1){
        s = s + 0.25
    ...
    var q1 = document.getElementById("q-1-1").checked ;
    if(q1){
        s++
    }
    ...
    var q3 = document.getElementById("q-3-1").checked ;
    if(q3){
        s++
    }
    ...
    var q9 = document.getElementById("q-9-2").checked ;
    if(q9){
        s++
    }
